"""
Django settings for tienda_suplementos project.
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': '',
        'HOST': 'localhost',  # Agrega el host si es diferente de localhost
        'PORT': '3306',  # Agrega el puerto si es diferente de 3306
    }
}
